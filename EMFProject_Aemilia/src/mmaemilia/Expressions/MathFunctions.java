 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.Expressions.MathFunctions#getName <em>Name</em>}</li>
 *   <li>{@link mmaemilia.Expressions.MathFunctions#getLeftExprMath <em>Left Expr Math</em>}</li>
 *   <li>{@link mmaemilia.Expressions.MathFunctions#getRightExprMath <em>Right Expr Math</em>}</li>
 * </ul>
 *
 * @see mmaemilia.Expressions.ExpressionsPackage#getMathFunctions()
 * @model
 * @generated
 */
public interface MathFunctions extends Expression {
	 ...
	 * The literals are from the enumeration {@link mmaemilia.Expressions.MathFuncName}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getMathFunctions_Name()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.MathFunctions#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getMathFunctions_LeftExprMath()
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.MathFunctions#getLeftExprMath <em>Left Expr Math</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getMathFunctions_RightExprMath()
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.MathFunctions#getRightExprMath <em>Right Expr Math</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
