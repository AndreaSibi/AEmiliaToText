/**
 */
package mmaemilia.QueueingNetwork.impl;

import mmaemilia.QueueingNetwork.QueueingNetworkPackage;
import mmaemilia.QueueingNetwork.TimeUnitsType;
 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getWorkloadID <em>Workload ID</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getResidenceTime <em>Residence Time</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getQueueLength <em>Queue Length</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getEReference0 <em>EReference0</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getEReference1 <em>EReference1</em>}</li>
 *   <li>{@link mmaemilia.QueueingNetwork.impl.WorkloadClassImpl#getTimeUnits <em>Time Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkloadClassImpl extends MinimalEObjectImpl.Container implements WorkloadClass {
	/**
