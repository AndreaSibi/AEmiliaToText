 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.Expressions.BooleanExpr#getOperator <em>Operator</em>}</li>
 *   <li>{@link mmaemilia.Expressions.BooleanExpr#getLeftExprBool <em>Left Expr Bool</em>}</li>
 *   <li>{@link mmaemilia.Expressions.BooleanExpr#getRightExprBool <em>Right Expr Bool</em>}</li>
 * </ul>
 *
 * @see mmaemilia.Expressions.ExpressionsPackage#getBooleanExpr()
 * @model
 * @generated
 */
public interface BooleanExpr extends Expression {
	 ...
	 * The literals are from the enumeration {@link mmaemilia.Expressions.BoolOpName}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getBooleanExpr_Operator()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.BooleanExpr#getOperator <em>Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getBooleanExpr_LeftExprBool()
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.BooleanExpr#getLeftExprBool <em>Left Expr Bool</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mmaemilia.Expressions.ExpressionsPackage#getBooleanExpr_RightExprBool()
	...
	/**
	 * Sets the value of the '{@link mmaemilia.Expressions.BooleanExpr#getRightExprBool <em>Right Expr Bool</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
