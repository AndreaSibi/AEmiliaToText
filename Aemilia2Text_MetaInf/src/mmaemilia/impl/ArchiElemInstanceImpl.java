 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getInstanceName <em>Instance Name</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getActualParam <em>Actual Param</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getTypeOf <em>Type Of</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getResponseTime <em>Response Time</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getInstanceUtilDistr <em>Instance Util Distr</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getInstanceThDistr <em>Instance Th Distr</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getInstanceResTimeDistr <em>Instance Res Time Distr</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getQueueLength <em>Queue Length</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getElem <em>Elem</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiElemInstanceImpl#getSelector <em>Selector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArchiElemInstanceImpl extends MinimalEObjectImpl.Container implements ArchiElemInstance {
	/**
