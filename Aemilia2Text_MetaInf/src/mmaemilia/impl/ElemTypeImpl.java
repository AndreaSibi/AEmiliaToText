 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getIiDecl <em>Ii Decl</em>}</li>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getOiDecl <em>Oi Decl</em>}</li>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getEtName <em>Et Name</em>}</li>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getElemHeader <em>Elem Header</em>}</li>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getBehaviorDecl <em>Behavior Decl</em>}</li>
 *   <li>{@link mmaemilia.impl.ElemTypeImpl#getClasses <em>Classes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElemTypeImpl extends MinimalEObjectImpl.Container implements ElemType {
	/**
