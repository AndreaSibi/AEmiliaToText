 ...
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getResidenceTime <em>Residence Time</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getQueueLength <em>Queue Length</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link mmaemilia.impl.ArchiTypeImpl#getWorkloads <em>Workloads</em>}</li>
 * </ul>
 *
 * @generated
 */
