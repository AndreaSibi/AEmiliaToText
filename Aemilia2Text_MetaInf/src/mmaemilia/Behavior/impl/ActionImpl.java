/**
 */
package mmaemilia.Behavior.impl;

import java.util.Collection;

import mmaemilia.Behavior.Action;
import mmaemilia.Behavior.ActionRate;
import mmaemilia.Behavior.ActionType;
 ...
 * </p>
 * <ul>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getName <em>Name</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActThroughtput <em>Act Throughtput</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActUtilization <em>Act Utilization</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActResponseTime <em>Act Response Time</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getRate <em>Rate</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getIs <em>Is</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getBelongs <em>Belongs</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActThDistr <em>Act Th Distr</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActRespTimeDistr <em>Act Resp Time Distr</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getActUtilDistr <em>Act Util Distr</em>}</li>
 *   <li>{@link mmaemilia.Behavior.impl.ActionImpl#getElem <em>Elem</em>}</li>
 * </ul>
 *
 * @generated
 */
